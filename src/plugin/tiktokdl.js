          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              header: proto.Message.InteractiveMessage.Header.create({
                ...
                title: "https://telegra.ph/file/c6cb8ed15edc86e94c893.jpg",
                gifPlayback: true,
                subtitle: "",
      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> © Powered by 𝐄𝐝𝐧𝐮𝐭-𝐌𝐝' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: '> © Powered by 𝐄𝐝𝐧𝐮𝐭-𝐌𝐝' };
          }
